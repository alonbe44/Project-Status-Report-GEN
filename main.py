...
def Gen_Document(mp,filename):
    ...
    for number in range(1, size):
        ...
        row_cells[5].text = str(mp['Duration'].get(number,''))
    ...
    directory = "Projects_"+str(datetime.now().strftime("%Y"))
    ...
    print(f"File '{filename}' has been created in '{directory}'.")
...
def Collect_Data():
    ...
    for number in range(1, size):
        ...
        try:
            ...
            mp['Duration'][number] = time.strftime(str(to_date - from_date))
...
##////*[@id="Project_listView_row_16"]/td[7]/span[1]/span
            from_date = browser.find_element(By.XPATH, '//*[@id="Project_listView_row_' + str(
