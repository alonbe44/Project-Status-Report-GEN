...
from data_Visualization import Data_VisualizationDiagrams
...
class TestDataVisualization(unittest.TestCase):
    ...
    def test_generates_all_visualizations_for_valid_input_data(self):
        map_data = pd.DataFrame({'project name': {1: 'Speech Log expansion', 2: 'PMP (Expansion Telesales)',
                                                  3: 'SpeechLog (Screen Capture, 27 Licenses)', 4: 'SpeechLog',
                                                  5: 'SpeechLog (30 IP)',
                                                  6: 'RQMS on SAS', 7: 'SpeechLog Retail Zain KW (POC)',
                                                  8: 'Speech Log Recorder House Bank',
                                                  9: 'SpeechLog Voice Recording (IP) Kalaam',
                                                  10: 'Move 4 licenses to new server',
                                                  11: 'SpeechLog (Backup Recorder)', 12: 'SpeechLog (20 IP)',
                                                  13: 'Accudial (Upgrade)',
                                                  14: 'SpeechLog Al Rajhi Bank', 15: 'E911 integration with XLM',
                                                  16: 'E911 (Caller Barring Status)', 17: 'LTE, ITS & RS Upgrade',
                                                  18: 'Data Rating and Charging (Redundancy)',
                                                  19: 'Customer Order (Phase II)',
                                                  20: 'VAS Sub-charging CR', 21: 'MLC Upgrade', 22: 'Enabling-4G',
                                                  23: 'USSD GW Upgrade & CR',
                                                  24: 'SpeechLog (34 IP)', 25: 'JRM – E1 Recorder', 26: 'SpeechLog',
                                                  27: 'Roaming (Links Migration to HSL)', 28: 'Speech Analytics (POC)'},
                                 'Engineer name': {1: 'Nabeel Nusair', 2: 'Abdellateef Ibrahim', 3: 'Ahmad AlHasan',
                                                   4: 'Ahmad AlHasan',
                                                   5: 'Ahmad AlHasan', 6: 'Mohammad Alalami', 7: 'Tamer Wathaifi',
                                                   8: 'Bilal Al-Noori',
                                                   9: 'Hamzeh Shwemeh', 10: 'Bilal Al-Noori', 11: 'Abdulrahman Hasan',
                                                   12: 'Abdulrahman Hasan',
                                                   13: 'Abdulrahman Hasan', 14: 'Abdulrahman Hasan',
                                                   15: 'Hamzeh Shwemeh', 16: 'Hamzeh Shwemeh',
                                                   17: 'Yousef Mishael', 18: 'aladdin Shishani', 19: 'Khairy Khdeir',
                                                   20: 'Laith Al-Janaideh',
                                                   21: 'Zaid Hina', 22: 'Khairy Khdeir', 23: 'Zaid Hina',
                                                   24: 'Abdulrahman Hasan',
                                                   25: 'Abdulrahman Hasan', 26: 'Abdulrahman Hasan',
                                                   27: 'Yousef Mishael', 28: 'Nabeel Nusair',
                                                   },
                                 'Related To': {1: 'Earth Link', 2: 'Zain Jordan', 3: 'Zain Jordan',
                                                4: 'Takamol (Switch IRAQ)',
                                                5: 'Takamol (ALghanim)', 6: 'Etisalat UAE', 7: 'Zain KW',
                                                8: 'Housing Bank', 9: 'Kalaam',
                                                10: 'Metropolitan (Cinnamon Lakeside Colombo)', 11: 'Arab Bank',
                                                12: 'Jordan Commercial Bank (JCB)', 13: 'Housing Bank',
                                                14: 'Al Rajhi Bank', 15: 'PSD',
                                                16: 'Orange', 17: 'Ufone', 18: 'TeleCel', 19: 'Asiacell',
                                                20: 'Golis Somalia', 21: 'Zain Jordan',
                                                22: 'Asiacell', 23: 'Zain Jordan', 24: 'ABC BANK BH', 25: 'JRM',
                                                26: 'Al Rajhi Bank', 27: 'Ufone',
                                                28: 'Zain Iraq'},
                                 'status': {1: 'Initiated', 2: 'Waiting for Feedback', 3: 'In Progress',
                                            4: 'In Progress', 5: 'In Progress',
                                            6: 'In Progress', 7: 'In Progress', 8: 'Initiated', 9: 'In Progress',
                                            10: 'On Hold', 11: 'On Hold',
                                            12: 'In Progress', 13: 'In Progress', 14: 'In Progress', 15: 'On Hold',
                                            16: 'On Hold',
                                            17: 'In Progress', 18: 'In Progress', 19: 'In Progress', 20: 'In Progress',
                                            21: 'In Progress',
                                            22: 'In Progress', 23: 'In Progress', 24: 'In Progress', 25: 'In Progress',
                                            26: 'In Progress',
    ...
    def test_saves_all_generated_plots_successfully(self):
        ...
        result = Data_VisualizationDiagrams(map_data)
        ...
        self.assertTrue(
            os.path.exists(os.path.join(os.getcwd(), 'Diagrams', 'project_duration_over_time_line_chart.png')))
        self.assertTrue(os.path.exists(os.path.join(os.getcwd(), 'Diagrams', 'pair_plot.png')))
        self.assertTrue(
            os.path.exists(os.path.join(os.getcwd(), 'Diagrams', 'project_duration_by_department_violin_plot.png')))
        self.assertTrue(
            os.path.exists(os.path.join(os.getcwd(), 'Diagrams', 'project_status_by_engineer_stacked_bar_chart.png')))
